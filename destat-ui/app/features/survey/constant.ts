export const SURVEY_FACTORY = "0xf500F37DA35a5B33ccb422E5d42A29158b0D6aaC";
    ...
    inputs: [
      {
        ...
        internalType: "struct SurveyShcema",
        name: "_survey",
        type: "tuple",
      },
    ],
...
] as const; //as const 의미 : immutable 이 배열을 불변하게 만들어야 wagmi에서 타입에러를 내놓지 않는다
